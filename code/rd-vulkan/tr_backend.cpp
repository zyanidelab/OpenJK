...
static void RB_BeginDrawingView (void) {
		...
		{	// portal scene, clear whatever is necessary
			...
			{	// fastsky: clear color
				...
				if (tr.world && tr.world->globalFog != -1)
				{
                    ...
                    color[0] = fog->parms.color[0];
                    color[1] = fog->parms.color[1]; 
                    color[2] = fog->parms.color[2];
                    color[3] = 1.0f;
	...
	vk_clear_attachments(vk_world.dirty_depth_attachment | clearStencil, clearColor, color);
